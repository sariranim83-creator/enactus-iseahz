-- Enactus ISEAHZ — seed data
-- Populates content_blocks with the club's initial, real content (no invented
-- facts). Safe to re-run: uses upsert. Dollar-quoting ($$...$$) avoids manual
-- escaping of apostrophes in the French copy.
...
('hero', $$
{
  "headline": { "en": "Young leaders creating sustainable impact.", "fr": "De jeunes leaders qui créent un impact durable." },
...
{
  "year": "2026–2027",
  "ambitionStatement": { "en": "Build boldly. Lead responsibly. Create impact that lasts.", "fr": "Construire avec audace. Diriger avec responsabilité. Créer un impact durable." },
  "annualVision": {
...
('enactus_explainer', $$
{
  "entrepreneurial": { "en": "Igniting business innovation with integrity and passion.", "fr": "Susciter l'innovation entrepreneuriale avec intégrité et passion." },
  "action": { "en": "The experience of social impact that sparks social enterprise.", "fr": "L'expérience de l'impact social qui donne naissance à l'entreprise sociale." },
  "us": { "en": "Student, academic and business leaders collaborating to create a better world.", "fr": "Des leaders étudiants, académiques et professionnels qui collaborent pour créer un monde meilleur." },
  "globalPurpose": {
...
('why_join', $$
[
  { "order": 1, "number": "01", "title": { "en": "Professional Growth", "fr": "Développement professionnel" }, "description": { "en": "Build communication, teamwork, leadership and business skills.", "fr": "Développer des compétences en communication, en travail d'équipe, en leadership et en gestion." } },
  { "order": 2, "number": "02", "title": { "en": "Business English", "fr": "Anglais professionnel" }, "description": { "en": "Create opportunities for students to practice professional English in real situations.", "fr": "Créer des occasions pour les étudiants de pratiquer l'anglais professionnel dans des situations réelles." } },
  { "order": 3, "number": "03", "title": { "en": "Communication", "fr": "Communication" }, "description": { "en": "Develop confidence in speaking, presenting, networking and collaborating.", "fr": "Gagner en confiance pour parler en public, présenter, réseauter et collaborer." } },
  { "order": 4, "number": "04", "title": { "en": "Entrepreneurship", "fr": "Entrepreneuriat" }, "description": { "en": "Learn to think entrepreneurially and turn problems into opportunities.", "fr": "Apprendre à penser en entrepreneur et à transformer les problèmes en opportunités." } },
  { "order": 5, "number": "05", "title": { "en": "Sustainability", "fr": "Durabilité" }, "description": { "en": "Understand how sustainability connects to education, business and community development.", "fr": "Comprendre le lien entre durabilité, éducation, entrepreneuriat et développement communautaire." } },
  { "order": 6, "number": "06", "title": { "en": "Team Culture", "fr": "Culture d'équipe" }, "description": { "en": "Create a supportive, fun environment where students feel they belong.", "fr": "Créer un environnement bienveillant et convivial où chaque étudiant se sent à sa place." } },
  { "order": 7, "number": "07", "title": { "en": "Competition", "fr": "Compétition" }, "description": { "en": "Prepare seriously and professionally for Enactus Tunisia's National Competition.", "fr": "Se préparer sérieusement et professionnellement pour la Compétition Nationale Enactus Tunisie." } },
  { "order": 8, "number": "08", "title": { "en": "Your CV", "fr": "Votre CV" }, "description": { "en": "Gain real experiences, responsibilities, teamwork and leadership experiences that can strengthen your professional profile.", "fr": "Acquérir de vraies expériences — responsabilités, travail d'équipe, leadership — qui viennent renforcer votre profil professionnel." } }
]
$$::jsonb),
('culture', $$
{
  "headline": { "en": "Grow together. Have fun. Build something meaningful.", "fr": "Grandir ensemble. S'amuser. Construire quelque chose qui compte." },
  "description": {
...
('sdgs', $$
[
  { "id": "sdg4", "number": 4, "name": { "en": "Quality Education", "fr": "Éducation de qualité" }, "description": { "en": "Ensure inclusive and equitable quality education and promote lifelong learning opportunities for all.", "fr": "Assurer l'accès de tous à une éducation de qualité, équitable et inclusive, et promouvoir des possibilités d'apprentissage tout au long de la vie." }, "whyItMatters": { "en": "As future educators, quality education is at the heart of who we are and what we build together.", "fr": "En tant que futurs éducateurs, l'éducation de qualité est au cœur de ce que nous sommes et de ce que nous construisons ensemble." }, "iconUrl": null, "slot": "primary", "order": 1 },
  { "id": "sdg5", "number": 5, "name": { "en": "Gender Equality", "fr": "Égalité entre les sexes" }, "description": { "en": "Achieve gender equality and empower all women and girls.", "fr": "Parvenir à l'égalité des sexes et autonomiser toutes les femmes et les filles." }, "whyItMatters": { "en": "We believe leadership opportunities and student entrepreneurship should be open and accessible to everyone, equally.", "fr": "Nous croyons que les opportunités de leadership et d'entrepreneuriat étudiant doivent être ouvertes et accessibles à tous, à égalité." }, "iconUrl": null, "slot": "supporting", "order": 2 },
  { "id": "sdg10", "number": 10, "name": { "en": "Reduced Inequalities", "fr": "Inégalités réduites" }, "description": { "en": "Reduce inequality within and among countries.", "fr": "Réduire les inégalités dans les pays et d'un pays à l'autre." }, "whyItMatters": { "en": "Local impact means making sure opportunities for growth and learning reach students across our community, not just a few.", "fr": "L'impact local, c'est veiller à ce que les opportunités de croissance et d'apprentissage profitent à tous les étudiants de notre communauté, et non à une minorité." }, "iconUrl": null, "slot": "supporting", "order": 3 },
  { "id": "sdg16", "number": 16, "name": { "en": "Peace, Justice and Strong Institutions", "fr": "Paix, justice et institutions efficaces" }, "description": { "en": "Promote peaceful and inclusive societies, provide access to justice for all and build effective, accountable institutions.", "fr": "Promouvoir l'avènement de sociétés pacifiques et inclusives, assurer l'accès de tous à la justice et mettre en place des institutions efficaces, responsables et ouvertes à tous." }, "whyItMatters": { "en": "We're building a club with strong governance and accountability — modelling the kind of institutions we want to contribute to.", "fr": "Nous construisons un club fondé sur une gouvernance solide et la responsabilité — à l'image des institutions auxquelles nous voulons contribuer." }, "iconUrl": null, "slot": "supporting", "order": 4 }
]
$$::jsonb),
('local_impact', $$
{
...
('seo', $$
{
  "pageTitle": { "en": "Enactus ISEAHZ | Young Leaders Creating Sustainable Impact", "fr": "Enactus ISEAHZ | De jeunes leaders qui créent un impact durable" },
  "metaDescription": {
    "en": "Enactus ISEAHZ is a student-led community at the Higher Institute of Applied Studies in Humanities of Zaghouan, empowering young leaders through entrepreneurship, sustainability, communication and experiential learning.",
    "fr": "Enactus ISEAHZ est une communauté étudiante de l'Institut Supérieur des Études Appliquées en Humanités de Zaghouan, qui forme de jeunes leaders à travers l'entrepreneuriat, la durabilité, la communication et l'apprentissage par l'action."
  },
